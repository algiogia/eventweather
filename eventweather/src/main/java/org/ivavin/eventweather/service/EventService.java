...
public interface EventService {
	 ...
	 */
	List<Event> getEvents(String location, String category, String... queryParams) throws EventServiceException;
	 ...
	 */
	List<String> getCategories() throws EventServiceException;
}
